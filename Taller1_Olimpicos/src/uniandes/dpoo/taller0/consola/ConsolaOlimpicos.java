...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el Pais al que pertenece un atleta");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	// Le muestra el ususario el pais al que pertenece el deportista que el proporciono
	
	private void ejecutarAquePaisPertenece() {
		
		String Natleta= input("Por favor ingrese el nombre del atleta para el cual desea encontrar el pais");
		String paisF = calculadora.AquePaisPertenece(Natleta);
		if (paisF != null) {
		System.out.println("El pais al que pertenece el deportista mencionado es: " + paisF);
	}
		else {
			System.out.println("El nombre del atleta que ha proporcionado no se encuentra registrado, ");
			System.out.println("intente con un nombre diferente o en su defecto con el nombre completo del deportista.");
		}
	}	
	/**
