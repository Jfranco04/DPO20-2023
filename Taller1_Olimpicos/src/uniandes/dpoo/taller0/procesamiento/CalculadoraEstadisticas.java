...
public class CalculadoraEstadisticas
{
	...
	/* Retorna el nombre del pais al que pertenece el atleta pasado por parametro
	 * @param Nombre del atleta al que se le esta buscando el pais
	 * @return Nombre del pais del atleta seleccionado
	 */
	
	public String AquePaisPertenece(String nombreAtleta) {
		Atleta elAtleta = buscarAtleta(nombreAtleta);
		if (elAtleta != null) {
		Pais paisAtleta = elAtleta.darPais();
